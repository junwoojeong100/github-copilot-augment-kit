...
- 팩트체크 수행 시 [fact-check 스킬](skills/fact-check/SKILL.md)을 로드하여 상세 워크플로우를 따릅니다.

**기본 팩트체크 형식** (스킬 로드 실패 시에도 아래 형식을 따릅니다):

| 검증 등급 | 의미 |
|-----------|------|
| ✅ 확실함 | 학습 데이터에서 확인된 높은 신뢰도 사실 |
| 🟡 대체로 정확 | 대체로 맞으나 세부사항 차이 가능 |
| ⚠️ 불확실 | 확인 어렵거나 최신 정보 필요 |
| ❌ 수정 필요 | 오류 발견, 올바른 정보를 비고에 기재 |
