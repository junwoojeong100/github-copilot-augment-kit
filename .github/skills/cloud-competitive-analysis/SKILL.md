...
- **GitHub 서비스 설명**: Actions, Advanced Security, Packages, Codespaces, Copilot 등 GitHub 핵심 서비스 설명이 필요할 때
...
| GitHub 핵심 서비스 설명 | [github-services-overview.md](./references/github-services-overview.md) |
