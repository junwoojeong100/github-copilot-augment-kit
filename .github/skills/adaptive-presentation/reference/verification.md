...
python3 .github/skills/adaptive-presentation/scripts/render_pptx.py \
  deck.pptx --out /tmp/deck-qa
```
...
```bash
python3 .github/skills/adaptive-presentation/scripts/render_pptx.py \
  deck.pptx --slides 8,16,22 --keep-slide-images --out /tmp/deck-detail
```
...
저장소에는 최종 PPTX, 재생성 스크립트, 사용자가 요청한 문서만 남긴다.
